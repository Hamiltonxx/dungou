...
省份,图片,  
刀盘直径(m),刀盘型式,开口率(%),中心鱼尾刀,先行刀,切削刀,刮刀,超挖刀,双刃滚刀,单刃滚刀,驱动方式,最大转速(r/min),额定扭矩(kN.m),脱困扭矩(kN.m),泡沫,膨润土,最大推力(kN),最大推速(mm/min),螺旋机型式,直径(mm),最大通过粒径(mm),最大出土量(m3/h),最大扭矩(kN.m),螺旋机转速(r/min)  
其中, [中心鱼尾刀,先行刀,切削刀,刮刀,超挖刀,双刃滚刀,单刃滚刀] 合为 刀具配置, [驱动方式,最大转速,额定扭矩,脱困扭矩] 合为 动力配置, [泡沫,膨润土] 合为 添加剂注入口, [刀盘直径,刀盘型式,开口率,刀具配置,动力配置,添加剂注入口] 合为 刀盘系统, [最大推力,最大推速] 合为 推进系统, [螺旋机型式,直径,最大通过粒径,最大出土量,最大扭矩,螺旋机转速] 合为 出渣系统
